...
:local startBuf [:toarray [/log find where message~"(logged in from|logged out from|invalid MAC address|login failure|loop|down|fcs|excessive|rebooted|ipsec|ike2|untrusted|flooding)" \ or topics~"(error|critical)"]]
